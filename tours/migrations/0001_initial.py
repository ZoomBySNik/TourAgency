    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('additional_service', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='tours.additionalservice', verbose_name='Дополнительная услуга')),
                ('tour', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='tours.tour', verbose_name='Тур')),
            ],
            options={
                'verbose_name': 'Услуга',
        ...
        migrations.AddField(
            model_name='livingconditions',
            name='type_of_hotel_catering',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='tours.typeоfhotelcatering', verbose_name='Тип питания'),
        ),
        migrations.AddField(
            model_name='livingconditions',
            name='type_of_hotel_room',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='tours.typeofhotelroom', verbose_name='Тип номера'),
        ),
        migrations.CreateModel(
